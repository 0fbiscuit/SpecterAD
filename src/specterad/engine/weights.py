...
_DEFAULT_WEIGHTS: dict[str, dict[str, float]] = {
    ...
    "ADCSESC10":            {"detection": 0.4,  "failure": 0.25, "complexity": 0.6},
    "ADCSESC11":            {"detection": 0.45, "failure": 0.25, "complexity": 0.6},
    "ADCSESC12":            {"detection": 0.5,  "failure": 0.3,  "complexity": 0.7},
    ...
    "Enroll":               {"detection": 0.1,  "failure": 0.05, "complexity": 0.2},
    "AutoEnroll":           {"detection": 0.05, "failure": 0.02, "complexity": 0.1},
    # ACL Extended
    "WriteScriptPath":      {"detection": 0.2,  "failure": 0.1,  "complexity": 0.3},
    "WriteProfilePath":     {"detection": 0.2,  "failure": 0.1,  "complexity": 0.3},
    "WriteHomeDirectory":   {"detection": 0.2,  "failure": 0.1,  "complexity": 0.3},
    "WriteMSDSAllowedToAct": {"detection": 0.2, "failure": 0.1,  "complexity": 0.4},
    "AddAllowedToAct":      {"detection": 0.2,  "failure": 0.1,  "complexity": 0.4},
    "CreateChild":          {"detection": 0.15, "failure": 0.05, "complexity": 0.3},
    "DeleteChild":          {"detection": 0.3,  "failure": 0.1,  "complexity": 0.3},
    "DeleteTree":           {"detection": 0.5,  "failure": 0.1,  "complexity": 0.3},
    "WriteGPO":             {"detection": 0.3,  "failure": 0.1,  "complexity": 0.5},
    # Lateral Extended
    "CanSSH":               {"detection": 0.5,  "failure": 0.3,  "complexity": 0.3},
    "RemoteInteractiveLogon": {"detection": 0.7, "failure": 0.4, "complexity": 0.3},
    # Coercion
    "CoerceToTGT":          {"detection": 0.6,  "failure": 0.3,  "complexity": 0.5},
    "CoerceToNTLM":         {"detection": 0.5,  "failure": 0.2,  "complexity": 0.4},
    # LAPS Extended
    "SyncLAPSPassword":     {"detection": 0.2,  "failure": 0.05, "complexity": 0.2},
    # DCSync Extended
    "GetChangesInFilteredSet": {"detection": 0.6, "failure": 0.1, "complexity": 0.4},
    # Structural
